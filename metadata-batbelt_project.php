		...
		<ul class="meta2 fa-ul">
			...
			<li class="roles"><i class="fa-li fa fa-user"></i> <span class="meta-label"><?php _e( 'Roles: ' , 'fumseck' ); ?></span><?php echo $batbelt_roles_list ; ?></li>
			<?php }; ?>
			...
			<li class="projects"><i class="fa-li fa fa-tasks"></i> <span class="meta-label"><?php _e( 'Part of: ' , 'fumseck' ); ?></span><?php fumseck_linked_title( $batbelt_project ); ?></li>
			<?php }; ?>
