...
<div class="image-post-content">
	...
	<div class="container">
		<nav class="nav-links">
			<div class="nav-link previous"><?php next_post_link('%link', '<i class="fa fa-caret-left"></i> ' . __( 'Previous photo ' , 'fumseck' )) ?></div>
			<div class="nav-link next"><?php previous_post_link('%link', __( 'Next photo ' , 'fumseck' ) . '<i class="fa fa-caret-right"></i>') ?></div>
		</nav>
	</div>
